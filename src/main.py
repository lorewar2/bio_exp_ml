...
def main():
    ...
    util.get_base_context_from_file("/data1/hifi_consensus/all_data/7_base_context/chr2_errors.txt", "/data1/hifi_consensus/all_data/7_base_context/chr2_mutation_context.txt", 0.85)
    return
