...
def main():
    ...
    util.filter_data_using_confident_germline_indel_depth("chr2", "/data1/hifi_consensus/all_data/chr2.txt", "/data1/hifi_consensus/all_data/filters", "/data1/hifi_consensus/all_data/chr2_filtered.txt")
